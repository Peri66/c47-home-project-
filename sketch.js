...
var zombieGroup;
var win_sound,lose_sound,bullet_sound;
...
function preload(){
  ...
  bullet_sound = loadSound("assets/explosion.mp3");
...
fill("white")
textSize(20);
text("score:"+score,displayWidth-500,displayHeight/2-400);


text("lives:"+lives,displayWidth-400,displayHeight/2-400);
text("bullets:"+bullets,displayWidth-600,displayHeight/2-400);
